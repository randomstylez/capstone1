...
urlpatterns = [
    ...
    path('<int:service_id>/', ServiceHistoryView.as_view(), name='service_history_view'),
    path('subscription/<int:service_id>/', SubscriptionView.as_view(), name='subscription_view'),
    path('details/<int:ticket_id>/', ServiceHistoryDetailsView.as_view(), name='service_history_details_view'),
